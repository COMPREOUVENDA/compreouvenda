        ...
        <div className="w-full max-w-md card-elevated p-8 animate-slide-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="/forgot" className="text-sm text-brand-blue hover:underline">
                Esqueci minha senha
              </Link>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button onClick={handleGoogle} className="btn-secondary flex items-center justify-center gap-2 text-sm py-2.5">
            ...
            <button className="btn-secondary flex items-center justify-center gap-2 text-sm py-2.5" disabled>
